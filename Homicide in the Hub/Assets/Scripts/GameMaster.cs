...
//Used for take in pick items
 ...
 public class GameMaster : MonoBehaviour {
	...
	*/
	...
	public GameObject sandwichPrefab;      //ADDITION BY WEDUNNIT
    ...
    //initialise all the speech lists    //ADDITION BY WEDUNNIT
     private List<string> hemanResponses = new List<string>();
     ...
     private List<string> reginaldResponses = new List<string>();
    ...
    JSONObject jObject = new JSONObject(File.ReadAllText("speech.JSON"));
    ...
    void Start(){
        ...
        Dictionary<string,List<string>> speechDict = sh.accessData(jObject);
        foreach (var character in speechDict)
        {
            print(character.Key);
            //testing loop please ignore
            foreach (var line in speechDict[character.Key])
            {
                print(line);
            }
            ...
            {
                case "Pirate":
                    pirateResponses = speechDict[character.Key];
                    break;
                case "Mime":
                    mimeResponses = speechDict[character.Key];
                    break;
                case "Millionaire":
                    millionaireResponses = speechDict[character.Key];
                    break;
                case "Cowgirl":
                    cowgirlResponses = speechDict[character.Key];
                    break;
                case "Roman":
                    romanResponses = speechDict[character.Key];
                    break;
                case "Wizard":
                    wizardResponses = speechDict[character.Key];
                    break;
                case "Chubbie":
                    chubbieResponses = speechDict[character.Key];
                    break;
                case "HeMan":
                    hemanResponses = speechDict[character.Key];
                    break;
                case "Reginald":
                    reginaldResponses = speechDict[character.Key];
                    break;
                case "Scientist":
                    scientistResponses = speechDict[character.Key];
                    break;
            }
        }
